...
// (https://godoc.org/github.com/divyanshgaba/go-agent/v3/integrations/nrnats/#StartPublishSegment)
...
// https://github.com/divyanshgaba/go-agent/blob/master/v3/integrations/nrstan/examples/main.go
package nrstan
