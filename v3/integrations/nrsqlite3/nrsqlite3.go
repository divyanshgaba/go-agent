...
//
//	import (
//		_ "github.com/divyanshgaba/go-agent/v3/integrations/nrsqlite3"
//	)
//
//	func main() {
...
// https://github.com/divyanshgaba/go-agent/tree/master/v3/integrations/nrsqlite3/example/main.go
package nrsqlite3
