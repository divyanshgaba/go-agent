...
// (https://godoc.org/github.com/divyanshgaba/go-agent/v3/integrations) directory --
...
// (https://godoc.org/github.com/divyanshgaba/go-agent/v3/newrelic#Transaction.AddAttribute)
