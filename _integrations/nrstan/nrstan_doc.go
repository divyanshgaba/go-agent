...
// (https://godoc.org/github.com/divyanshgaba/go-agent/_integrations/nrnats/#StartPublishSegment)
...
// https://github.com/divyanshgaba/go-agent/blob/master/_integrations/nrstan/examples/main.go
package nrstan
